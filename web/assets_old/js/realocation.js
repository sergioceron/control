...
$(document).ready(function() {
    ...
    for (var i=0; i < 50; i++) {
        ...
        contents.push('<div class="infobox"><div class="infobox-header"><h3 class="infobox-title"><a href="#">30 Miller Pl Apt 3</a></h3><h4 class="infobox-subtitle"><a href="#">San Francisco, CA</a></h4></div><div class="infobox-picture"><a href="#"><img src="http://html.realocation.byaviators.com/assets/img/tmp/properties/medium/'+Math.floor((Math.random()*10)+1) +'.jpg" alt=""></a><div class="infobox-price">$ 13,000</div></div></div>');
    ...
    if ($('#map').length !== 0) {
        var map = $('#map').aviators_map({
            //locations: locations,
            //contents: contents,
            url: "/seam/resource/rest/map/query",
            filterForm: "#search",
            types: types,
            images: images,
            zoomControl: true,
